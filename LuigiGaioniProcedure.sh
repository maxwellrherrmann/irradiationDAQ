...
LGProcedure() { #only for pre iradiation characterization of CROC	
	...
	trap 'rm $macro_name; echo SIGINT signal found; return' SIGINT #cleans up in the event of a ctrl c call
	echo "{" >> $macro_name
	...
	trap 'rm $macro_name; mv $temp_tdac_name tdac.csv; echo SIGINT signal found; return' SIGINT #cleans up in the event of CTRL c call
	...
	trap 'rm $macro_name; mv $temp_tdac_name tdac.csv; mv $temp_RD53B_name RD53B.toml; echo SIGINT signal found; return' SIGINT
		...
		do
			...
			do
				...
				then
					...
					trap 'rm $macro_name; mv $temp_tdac_name tdac.csv; mv $temp_RD53B_name RD53B.toml; rm -r $dest_path ; echo SIGINT signal found; return' SIGINT
